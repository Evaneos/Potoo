...
def preprod():
    ...
    env.directory = '/home/evaneos/watchme/preprod'
    env.supervisor    = 'evaneos-watchme-preprod:'
    env.siteUrl = 'https://watchme.evaneos.chapplications.com/'
    env.allowTagging = True
...
def prod():
    env.environment   = 'prod'
    env.hosts     = 'hurpeau.com'
    env.directory = '/home/evaneos/watchme/prod'
    env.supervisor    = 'evaneos-watchme:'
    env.siteUrl = 'https://watchme.evaneos.chapplications.com'
    env.allowTagging = True
    env.allowDeployBranch = False
    env.checkHasCommitFromBranch = 'master'
